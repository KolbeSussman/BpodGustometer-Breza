%{
rightSideTraining Function Documentation
========================================

**Purpose:**
The `rightSideTraining` function executes a behavioral training protocol 
...
- `currentTrialType`: Integer defining the type of the current trial (set to 1 for all trials).
...
7. **Pause and Exit Conditions:**
   ...
   - **Exit Condition**:
     - If the protocol is stopped (`BpodSystem.Status.BeingUsed == 0`), the
     function exits.
...
function rightSideTraining
    ...
    for currentTrial = 1:MaxTrials
        ...
        StimulusOutputActions = {'ValveModule1', 2}; % Action to open valve
        ...
        sma = AddState(sma, 'Name', 'WaitForResponse', ...
            'Timer', 15, ... 
            'StateChangeConditions', {'Port1In', 'Punish', 'Port3In', 'Reward',  'Tup', 'NextTrial'}, ...
            'OutputActions', {});
