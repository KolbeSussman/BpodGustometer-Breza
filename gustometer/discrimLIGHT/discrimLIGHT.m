%{
gustometerWITHLIGHT Function Documentation
==========================================

**Purpose:**
The `gustometerWITHLIGHT` function implements a behavioral training protocol using the Bpod system, 
with additional functionality to control a light stimulus. It conducts a series of trials with randomized 
trial types, delivers stimuli, collects responses, and administers rewards or punishments based on trial type.
     ...
     - In each iteration:
       ...
       - **Determine Trial-Specific Actions:**
         - Based on `TrialTypes(currentTrial)`, sets actions for:
           - Stimulus delivery (including light control for trial type 1)
           - Reward delivery
           - Punishment
...
for currentTrial = 1:MaxTrials
    ...
    switch TrialTypes(currentTrial)
        case 1
            ...
            StimulusOutputActions = {'ValveModule1', 2, 'BNC1', 1}; % Action to open valve for trial type 1
